...
import (
	...
	"github.com/srijan-nayak/snippetbox/internal/validator"
	"net/http"
	"strconv"
)
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionManager.Put(r.Context(), sessionFlash, "Snippet successfully created!")
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionManager.Put(r.Context(), sessionFlash, "Your signup was successful. Please log in.")
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionManager.Put(r.Context(), sessionAuthenticatedUserID, id)
...
func (app *application) userLogoutPost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionManager.Remove(r.Context(), sessionAuthenticatedUserID)
	app.sessionManager.Put(r.Context(), sessionFlash, "You've been logged out successfully")
